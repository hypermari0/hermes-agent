...
_SCHEMA_OVERRIDES: Dict[str, Dict[str, Any]] = {
    ...
    "stt.language": {
        "type": "select",
        "description": "Global STT language hint applied to every provider (empty = auto-detect)",
        "options": ["", "en", "pt", "es", "fr", "de", "it", "ja", "zh", "ru", "uk", "tr", "ar", "hi"],
    },
    "stt.local.language": {
        "type": "select",
        "description": "Force a language for local STT (empty = inherit stt.language)",
        "options": ["", "en", "pt", "es", "fr", "de", "it", "ja", "zh", "ru", "uk", "tr", "ar", "hi"],
    },
    "stt.groq.model": {
        "type": "select",
    ...
    "stt.groq.language": {
        "type": "select",
        "description": "Force a language for Groq STT (empty = inherit stt.language)",
        "options": ["", "en", "pt", "es", "fr", "de", "it", "ja", "zh", "ru", "uk", "tr", "ar", "hi"],
    },
    "stt.openai.model": {
        "type": "select",
    ...
    "stt.openai.language": {
        "type": "select",
        "description": "Force a language for OpenAI STT (empty = inherit stt.language)",
        "options": ["", "en", "pt", "es", "fr", "de", "it", "ja", "zh", "ru", "uk", "tr", "ar", "hi"],
    },
    "stt.xai.language": {
        "type": "select",
        "description": "Force a language for xAI Grok STT (empty = inherit stt.language)",
        "options": ["", "en", "pt", "es", "fr", "de", "it", "ja", "zh", "ru", "uk", "tr", "ar", "hi"],
    },
